    ...
    <div id="year" class="container">
      <div class="row">
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[1]">
            <div class="col border day month-1"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
        ...
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[2]">
            <div class="col border day month-2"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
        ...
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[3]">
            <div class="col border day month-3"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
      ...
      <div class="row mt-3">
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[4]">
            <div class="col border day month-4"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
        ...
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[5]">
            <div class="col border day month-5"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
        ...
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[6]">
            <div class="col border day month-6"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
      ...
      <div class="row mt-3">
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[7]">
            <div class="col border day month-7"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
        ...
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[8]">
            <div class="col border day month-8"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
        ...
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[9]">
            <div class="col border day month-9"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
      ...
      <div class="row mt-3">
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[10]">
            <div class="col border day month-10"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
        ...
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[11]">
            <div class="col border day month-11"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
        ...
        <div class="col px-3">
          ...
          <div class="row text-center"
               v-for="week in calendar[12]">
            <div class="col border day month-12"
                 v-for="day in week">
              <template v-if="day">
                {{ formatDay(day) }}
              </template>
